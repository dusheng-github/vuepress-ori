<template>
  <div style="width: 700px">
    ...
    <div class="tab">
      <ul class="tabNav">
        <li class="active">
          <a href="http://www.jq22.com/">Attention Seekers</a>
        </li>
      ...
      <div class="tabCnt">
        ...
        <ul class="tabPane">
          <li>lightSpeedInRight</li>
          <li>lightSpeedInLeft</li>
          <li>lightSpeedOutRight</li>
          <li>lightSpeedOutLeft</li>
        </ul>
...
export default {
  ...
  methods: {
    getData() {
      ...
      const $btn = $(".tabCnt").find("li");
      $btn.click(function () {
        $(this).addClass("active").siblings().removeClass("active");
        $animate
          .removeClass()
          .addClass("animate__animated animate__" + $(this).text());
      ...
      const $tabNavItem = $(".tabNav").find("a");
